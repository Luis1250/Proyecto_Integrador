...
#define SSP_VERSION_STRING                  ("1.6.0")

/** Unique SSP version ID. */
#define SSP_VERSION_BUILD_STRING            ("Built with Renesas Synergy (TM) Software Package version 1.6.0+build.71ee1bc68846")
