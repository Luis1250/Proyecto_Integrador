 ...
 * @param[in] p_clck_cfg        pointer to the clock configuration structure
 ...
 * @param[in]  p_system_reg  pointer to system register structure
 * @param[in]  clock is the system clock to get the divider for
 ...
 * @param[in]  p_system_reg  pointer to system register structure
 * @param[in]  operating mode Operating power control mode
 * @retval     None
 **********************************************************************************************************************/
